...
<?php
	...
	echo '<div class="header-content-wrap">';
		...
		echo '<h2 class="intro-description" style="line-height: 30px; color: #fff;font-size:1em;">My name is Rodrigo Troncoso, I\'m a 21 years old software developer from Buenos Aires with expertise in state of the art technologies such as Laravel PHP, Node.js and Angular.js</h2>';
